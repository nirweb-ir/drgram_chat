<div class="input-area ">
    ...
    <div class="box_message_input">
        ...
        <div class="attach_file" id="btnUpload">
            <svg id="Layer_1" data-name="Layer 1" fill="#888888" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 110.27 122.88"
                 width="20px">
